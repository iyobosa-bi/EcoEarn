            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="adminwastecat.php" class="sidebar-link">
                        <i class="lni lni-user"></i>
                        <span>View Waste Category</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="wasteupdate.php" class="sidebar-link">
            ...
            <main class="content px-3 py-4" style="background-color: #ededed;">
                <div class="container-fluid">
                    <div class=" row mb-3">
                        ...
                        <div class="row mt-5">
                            <div class="col-10">
                                <h5>Update Waste Category</h5>
                                <?php
                                    if(isset($_SESSION['feedbackl'])){
                                        echo "<div class ='alert alert-success  text-center'>".$_SESSION['feedbackl']."</div>";
                                        unset($_SESSION['feedbackl']);
                                        }
                                        if(isset($_SESSION['errmsg'])){
                                            echo "<div class ='alert alert-danger  text-center'>".$_SESSION['errmsg']."</div>";
                                            unset($_SESSION['errmsg']);
                                            }
                    
                                ?>
                            <form action="process/updatewastecataction.php" method="post" id="wastecatform">
                                <input type="text" name="wastecat" id="wastecat" class="form-control noround border-dark" placeholder="Enter Waste category" value =  "<?php if(isset($_GET['catid'])){echo $res['cat_name'];}?>" >
