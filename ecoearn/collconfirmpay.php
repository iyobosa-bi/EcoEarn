                    ...
                    <div class="col-md-7 ">
                        <div class="card m-5 shadow-sm" style="width:110%;">
                                    <div class="card-body" >
                                        ...
                                        <?php
                                        if(isset($_SESSION['agent_id'])){
                                            echo "<p  class='mt-4'><b>Transaction Reference Number:</b>{$_SESSION['refno']}</p>";
                                            echo "<p  class=''><b>Email</b>:".$c->getcollemail($_SESSION['agent_id'])['email_address']."</p>";
                                            echo "<p class=''><b>Destination Email</b>:theadmin@ecoearn.com</p>";
                                            echo "<p class='mt-4'><b>Transaction Amount</b>: ₦" . number_format($payamount, 2) . "</p>";
                                        ...
                                        <form action="process/payconfirm.php" method="post">
                                            <div align='right'><button class='btn btn-primary' name='btnconfirm'>Proceed to Pay</button></div>
