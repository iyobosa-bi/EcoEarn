        ...
        <div class="container">
            <div class="row p-5">
                <div class="col-12 mt-5">
                    ...
                    <h5 class="text-center" style="text-transform:uppercase;">Login</h5>
                    <p class="text-center">Enter your email and password to login</p>

                    <div class="input-container">
                    <?php
                      if(isset($_SESSION['logerrmsg'])){
                        echo "<div class= 'alert alert-danger'>".$_SESSION['logerrmsg']."</div>";
                        unset($_SESSION['logerrmsg']);
                      }
                      
                      if(isset($_SESSION['restrictmessage'])){
                        echo "<div class= 'alert alert-danger'>".$_SESSION['restrictmessage']."</div>";
                        unset($_SESSION['restrictmessage']);
                      }
                    ?>
                        <form action="process/loginaction.php"  method="post">
                            ...
                            <input type="password" name="userpass" id="" placeholder="Password" class="form-control noround">

                            <select name="userorcollector" id="" class="form-select noround">
                                <option value="user">User</option>
                                <option value="collector">Collector</option>

                            </select>
                            <button type="submit" name="btn-uclogin" class="btn btn-dark noround col-12">LOGIN</button>
                        </form>
                     </div>
