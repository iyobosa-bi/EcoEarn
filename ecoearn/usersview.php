...
<div class="container-fluid ms-0 ps-0 mt-0">
        ...
        <div class="row">
            ...
            <div class="col-md-9" style="background-color:#fff;">
                    ...
                    <div class="col-12 mt-5 mx-4" style="font-family:'Abril Fatface',sanserif">Platform Users</div>
                    <p></p>

                    <button type="button" class="btn btn-dark m-4" style="font-size:12px">Total Users <span class="badge bg-primary rounded-pill" style="font-size:14px; margin-left:5px;">
                        <?php echo count($userdeets); ?>
                    </span>
                </button>

                    <div class="userstable m-4">
                            ...
                            <table class="table table-hover table-striped table-sm table-bordered">
                                ...
                                foreach($userdeets as $val){?>
                                    <tr>
                                        ...
                                        <td scope="col" class="text-center"><?php echo $val['phone_number']?></td>
                                        ...
                                        <td> 
                                            <a href="process/activestatusreport.php?userid=<?php echo $val['user_id']?>&astatus=restricted"><button class="btn btn-sm btn-secondary rounded-pill px-2" id="btnapprove" value="Approve"><i class="fa-solid fa-user-lock text-info"></i></i></button></a>
